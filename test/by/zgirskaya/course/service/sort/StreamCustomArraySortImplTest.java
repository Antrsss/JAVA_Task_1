...
import by.zgirskaya.course.service.sort.impl.StreamCustomArraySortImpl;
...
public class StreamCustomArraySortImplTest {

    private StreamCustomArraySortImpl sorter;
    ...
    @BeforeEach
    void setUp() {
        sorter = new StreamCustomArraySortImpl();
