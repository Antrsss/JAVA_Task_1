...
import main.by.java.course.specification.impl.IntervalSpecification;
...
class IntervalSpecificationTest {
    ...
    private MyArray uppercaseArray;
    private MyArray lowercaseArray;
    private MyArray mixedCaseArray;

    @BeforeEach
    void setUp() {
        uppercaseArray = MyArray.newBuilder()
                .setMyArray(new String[]{"ABC", "DEF"}) // ABC=65+66+67=198, DEF=68+69+70=207
                .build();

        lowercaseArray = MyArray.newBuilder()
    ...
    void testSpecifyWithSpecialCharacters() {
        MyArray specialArray = MyArray.newBuilder()
